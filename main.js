...
global.owner = ['6285704617188@s.whatsapp.net'] // Put your number here
global.mods = ['6285704617188@s.whatsapp.net'] // Want some help?
global.prems = ['6285704617188@s.whatsapp.net'] // Premium user has unlimited limit
...
setInterval(async () => {
  conn.logger.info('lagi di save di database . . .')
...
conn.welcome = 'Hai, @user!\nSemoga membawa makanan di grup @subject ini'
conn.bye = 'Semoga masuk neraka ya @user🤗'
